...
//            log.info("SEED_KISA.DECRYPT : "+new String(SEED_KISA.DECRYPT("zUBP4HK++qJYBEuC55e/ByVy8Sz24QIUlyb1AoKnaca+vJb9zVAhDAPMhjJ+HXODu5VUYk/zEEQW2Tv/Ybqd7O+MbLj44CxGV+YXqSoRMhLWqj0qxxfgPraDu0VSJgZHkVoFOBMruMdF/0EOJGOSRhGk4iebQweL7U/CaSQ9oQR7HGr+y4t64xxzHQZ9OmZi")));
...
//            log.debug(new String(SEED_KISA.ENCRYPT("jdbc:mysql://192.168.0.175:3306/upts_batch?useUnicode=true&characterEncoding=utf8".getBytes())));
//
//            log.info("SEED_KISA.DECRYPT : "+new String(SEED_KISA.DECRYPT("zUBP4HK++qJYBEuC55e/ByVy8Sz24QIUlyb1AoKnaca+vJb9zVAhDAPMhjJ+HXODu5VUYk/zEEQW2Tv/Ybqd7O+MbLj44CxGV+YXqSoRMhLWqj0qxxfgPraDu0VSJgZHkVoFOBMruMdF/0EOJGOSRhGk4iebQweL7U/CaSQ9oQR7HGr+y4t64xxzHQZ9OmZi")));
//            log.info("SEED_KISA.DECRYPT : "+new String(SEED_KISA.DECRYPT("kJFXV3zU+FMCh+U6FbnARjEi/CkCE2nLgopyfApnl0n5duKkDtyBBvfKulKU3MoXo0ZwpODxVz9GM0S20Yr93O1OAq0DnDhp49TmvhEGE2gBO0TGBlF7g4/d+4DQQHNxA7P3ACrYSIKZS9A5ZLMlwH+O5WC0hacx2sef8oGO0BsVJSajfzbWEv/0CcDaR9ia")));
//
//            log.info("KSign.DECRYPT : "+SecurityUtil.decryptKSign("tb_admins", "passwd", "gdyb21LQTcIANtvYMT7QVQ=="));

            System.out.println(new String(SEED_KISA.ENCRYPT("jdbc:mysql://10.0.50.10:3306/gmc_dfians?useUnicode=true&autoReconnect=true&useSSL=false&characterEncoding=utf8&allowMultiQueries=true&serverTimezone=UTC".getBytes())));
//            System.out.println(new String(SEED_KISA.ENCRYPT("jdbc:mysql://10.0.50.10:3306/gmc_dfians_batch?useUnicode=true&autoReconnect=true&useSSL=false&characterEncoding=utf8&allowMultiQueries=true&serverTimezone=UTC".getBytes())));
//            System.out.println(new String(SEED_KISA.ENCRYPT("up_bitcoin".getBytes())));
//            System.out.println(new String(SEED_KISA.ENCRYPT("ewBNBu+y+krK10IRm2hPxw==".getBytes())));
//            System.out.println(SecurityUtil.encryptSHA256(new String(SEED_KISA.ENCRYPT("UP!2jBMrn9wXDL5dwwk".getBytes()))));
//            System.out.println(SecurityUtil.encryptSHA256(new String(SEED_KISA.ENCRYPT("root".getBytes()))));
//            System.out.println(SEED_KISA.ENCRYPT("UP!2jBMrn9wXDL5dwwk".getBytes()));
//            System.out.println(SEED_KISA.ENCRYPT("UP!2jBMrn9wXDL5dwwk".getBytes()));
//            System.out.println(SEED_KISA.ENCRYPT("UP!2jBMrn9wXDL5dwwk".getBytes()));
            System.out.println((new String(SEED_KISA.DECRYPT("MktQTprVuT6UNwsgTcuBlxxOjlzIKWnaPuZYaSasypgLiDf2tCZqT70kfhjH1nhrXF6ASXSW12jRxKObdjVXuTR2GHtD5kdnqjaPCTQBzie/+J7zN540mYCL8k/xXyCnxXIV3H04QQHBJq4erFw962GcfxN8laN8wxirGltfJ6aHNFNQ8ovbupl/it9Rbe2gdeXoXFk/8umD5H58uNd/Eg=="))));
//            System.out.println((new String(SEED_KISA.DECRYPT("P5WbzcB1sN3fEBXU5Nwngg=="))));
//            System.out.println((new String(SEED_KISA.DECRYPT("Q6mHdCDcfT93/6wNccTyXk1zLB+mK5gLwddc850EWEFk2EQnvksMz1lD9CiHh7Bf"))));
//

//            String aa = SecurityUtil.encryptKSign("124", "135", "1234");
//            System.out.println(aa);
//            String bb = SecurityUtil.decryptKSign("111", "135", aa);
//            System.out.println(bb);
//            System.out.println(new String(SEED_KISA.ENCRYPT("jdbc:mysql://192.168.0.175:3306/upts?useUnicode=true&autoReconnect=true&useSSL=false&characterEncoding=utf8&allowMultiQueries=true".getBytes())));
//
//            System.out.println(SecurityUtil.encryptSHA256(new String(SEED_KISA.DECRYPT("1234"))));
//
//
//            System.out.println(SecurityUtil.encryptSHA256(new String(SEED_KISA.ENCRYPT("1234".getBytes()))));

//            System.out.println("1111 mb_trade_password ::::" +SecurityUtil.encryptSHA256(new String(SEED_KISA.ENCRYPT("1111".getBytes() ))));
//            System.out.println("1111 mb_trade_password ::::" +SecurityUtil.encryptSHA256(new String(SEED_KISA.ENCRYPT("1111".getBytes() ))));
//            System.out.println("1111 mb_trade_password ::::" +SecurityUtil.encryptSHA256(new String(SEED_KISA.ENCRYPT("1111".getBytes() ))));
