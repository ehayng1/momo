...
//        }
    ...
    public static String replace(String str, String oldStr, String newStr) {
        ...
        while ((index2 = str.indexOf(oldStr, index1)) >= 0) {
            result.append(str, index1, index2);
    ...
    public static String kor(String a) {
        ...
        try {
            if (a != null) {
                result = new String(a.getBytes(StandardCharsets.ISO_8859_1), "KSC5601");
            }
    ...
    public static String eng(String a) throws UnsupportedEncodingException {
        ...
        try {
            if (a != null) {
                result = new String(a.getBytes("KSC5601"), StandardCharsets.ISO_8859_1);
            }
        } catch (UnsupportedEncodingException usee) {
        }
        return result;
    ...
    public static String removeEndZero(String content) {
        return new DecimalFormat("#,###.########").format(new BigDecimal(content));
    }
