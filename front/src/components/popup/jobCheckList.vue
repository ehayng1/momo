      ...
      <div style="overflowy: scroll; height: 70vh; bottom: -35%" class="modal">
        <vueScroll :ops="ops">
          ...
          <div class="button_area" style="display: flex; flex-direction: row">
            ...
            <a :class="[{ unactive: select !== 3 }]" @click="handleSelect(3)">
              <button
                type="button"
                class=""
                style="font-weight: 700; font-size: 1.8rem"
          ...
          <div class="dialog_body">
            ...
            <div>
              ...
              >
                ...
                >
                  ...
                  <div
                    ...
                    :class="{
                      selected:
                        list.findIndex(el => el.value === item.title) > -1
                    }"
                  >
              ...
              <div v-else>
                <div v-if="select === 2">전체</div>
                <div v-else>
                  <button>전체</button> <button>안전교육 이수자만</button>
                </div>
              </div>
              <div
                style="
