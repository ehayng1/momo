<template>
  <div class="alarm">
    ...
    <div class="info">
      <!-- <h1
        class="title"
        style="border-bottom: 1px solid #e3e5e5; padding-bottom: 2rem"
      >
        메세지
      </h1> -->
    </div>
            ...
            >
              ...
              <div style="display: flex; flex-direction: column">
                <div style="display: flex; flex-direction: row">
                  <div
                    style="margin-bottom: 0.5rem; margin-right: 1rem"
                    class="username"
                  >
                    {{ item.chat_title }}
                  </div>
...
<script>
  ...
  import profile from '@/static/images/common/profile_big.svg'
  // import back from '@/components/layout/back'
  import api from '@/api/api'
  import moment from 'moment'

  export default {
    components: { subtitlesOff, profile },
    mounted() {
      this.getList()
      // this.outChatingRoom()
    },
